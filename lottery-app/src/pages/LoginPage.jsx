          ...
          <div className="ll-border">
            <div className="ll-card">
                  ...
                  <div className="ll-ring-inner">
                    <span className="ll-logo-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 38, height: 38 }}>
                      <svg viewBox="0 0 38 38" style={{ width: '100%', height: '100%', display: 'block' }}>
                        <defs>
                          <clipPath id="circleClipLogin">
                            <circle cx="19" cy="19" r="17" />
                          </clipPath>
                          <linearGradient id="goldStripeLogin" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="#A67C1E" />
                            <stop offset="50%" stopColor="#F5D77F" />
                            <stop offset="100%" stopColor="#A67C1E" />
                          </linearGradient>
                          <linearGradient id="darkStripeLogin" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stopColor="#0F1326" />
                            <stop offset="50%" stopColor="#1E2548" />
                            <stop offset="100%" stopColor="#0F1326" />
                          </linearGradient>
                          <radialGradient id="goldCircleLogin" cx="50%" cy="50%" r="50%">
                            <stop offset="0%" stopColor="#FFFDF5" />
                            <stop offset="70%" stopColor="#F3D072" />
                            <stop offset="100%" stopColor="#C99E32" />
                          </radialGradient>
                        </defs>
                        <g clipPath="url(#circleClipLogin)">
                          <rect x="0" y="0" width="38" height="9.5" fill="url(#goldStripeLogin)" />
                          <rect x="0" y="9.5" width="38" height="19" fill="url(#darkStripeLogin)" />
                          <rect x="0" y="28.5" width="38" height="9.5" fill="url(#goldStripeLogin)" />
                          <circle cx="19" cy="19" r="6.5" fill="url(#goldCircleLogin)" />
                        </g>
                      </svg>
                    </span>
                  </div>
                </div>
                <h1 className="ll-title">ເຂົ້າສູ່ລະບົບ</h1>
              ...
              <div className="ll-form-area">
                {fromPath && !error && (
                  <div className="ll-alert ll-alert-warn">
                    <span className="material-symbols-outlined" style={{ fontSize: 16, fontVariationSettings: "'FILL' 1" }}>info</span>
                    ກະລຸນາ login ກ່ອນເຂົ້າໃຊ້ໜ້ານີ້
                  </div>
                )}
                {error && (
                  <div className="ll-alert ll-alert-err">
                ...
                <form onSubmit={handleSubmit} noValidate>
                  {/* Username */}
                  <label className="ll-label">ຊື່ຜູ້ໃຊ້ (Username)</label>
                  <div className="ll-field">
                    <span className="material-symbols-outlined ll-input-icon" style={{ fontVariationSettings: "'FILL' 1" }}>person</span>
                    <input
                      type="text"
                      className="ll-input"
                  ...
                  {/* Password */}
                  <label className="ll-label">ລະຫັດຜ່ານ (Password)</label>
                  <div className="ll-field">
                    <span className="material-symbols-outlined ll-input-icon" style={{ fontVariationSettings: "'FILL' 1" }}>lock</span>
                    <input
                    ...
                    />
                    <button type="button" className="ll-eye" onClick={() => setShowPass(v => !v)}>
                  ...
                  {/* Submit */}
                  <button type="submit" disabled={loading} className="ll-submit">
                    {loading ? (
                      <>
                  ...
                  <Link to="/forgot-password" className="ll-forgot">
                    ລືມລະຫັດຜ່ານ?
                  </Link>
                </form>
                ...
                <Link to="/register" className="ll-register">
