        ...
        <div className="relative z-10 px-8 sm:px-10 py-9 sm:py-11 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-3.5 py-1 mb-4">
              <span className="material-symbols-outlined text-[#6cf8bb] text-[14px]">history</span>
          ...
          <div className="flex gap-3 shrink-0">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-5 py-3 text-center">
              <p className="text-[10px] font-bold text-white/60 uppercase tracking-wider mb-1">ທັງໝົດ</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-5 py-3 text-center">
              ...
              <p className="text-2xl font-black text-[#6cf8bb]">
                {draws?.[0]?.draw_number ?? '-'}
              </p>
              <p className="text-[10px] text-white/50 mt-0.5">ງວດ</p>
            </div>
