      ...
      <div className="text-center max-w-md">
        <div className="relative mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-24 h-24 rounded-3xl bg-[#eff3ff] dark:bg-[#1e2d4a] flex items-center justify-center shadow-lg">
              <span className="material-symbols-outlined text-5xl text-[#003fb1]" style={{ fontVariationSettings: "'FILL' 1" }}>search_off</span>
            </div>
          </div>
        </div>
        <h1 className="text-2xl font-black text-[#121c2a] dark:text-white mb-2">ບໍ່ພົບໜ້ານີ້</h1>
