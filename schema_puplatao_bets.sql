...
--     · avoid_pair   — ຄູ່ລູກ ທີ່ຄວນຫຼີກ (ຊະນະ ເມື່ອ ອອກ "ທັງສອງລູກ" ຄືກັນ)
--
--   bet_kind ບອກພຽງແຕ່ວ່າຄູ່ນັ້ນມາຈາກສູດໃດ — ເງື່ອນໄຂຊະນະຄືກັນທັງສອງສູດ:
--   ຜູ້ໃຊ້ທີ່ເອົາ "ຄູ່ຫຼີກ" ໄປແທງ ຄືການແທງວ່າຄູ່ນັ້ນຈະອອກແທ້.
--
...
--      P(ອອກທັງ a ແລະ b) = 1 − 2(5/6)³ + (4/6)³ ≈ 13.89%  → fair 7.20×
--      ໃຊ້ຮ່ວມກັນທັງສອງສູດ ຍ້ອນເງື່ອນໄຂຊະນະຄືກັນ.
--
--    ອັດຕາຈ່າຍຈິງ = 6× ທັງສອງສູດ ຕາມທີ່ເຈົ້າຂອງເກມກຳນົດ:
--      ແທງ 1,000 ຖືກແລ້ວໄດ້ຄືນ 6,000 ກີບ (ກຳໄລ 5,000)
--
--    ⚠ ໝາຍເຫດ: 6× ຕ່ຳກວ່າ fair 7.20× → ເຈົ້າຂອງເກມໄດ້ປຽບປະມານ 17% ຕໍ່ບິນ
--    ຖ້າແທງແບບສຸ່ມ. ເສັ້ນຄຸ້ມທຶນໃນໜ້າ /puplatao/bets = 1÷6 ≈ 16.7% ຊຶ່ງສູງກວ່າ
--    ອັດຕາຖືກແບບສຸ່ມ (13.89%) — ກຳໄລສະສົມທີ່ເປັນບວກຈຶ່ງມີຄວາມໝາຍ.
--    ສຳລັບ avoid_pair ຄູ່ທີ່ສູດເລືອກແມ່ນຄູ່ "ເຢັນ" ໂອກາດອອກຕ່ຳກວ່າ 13.89%
--    ອີກ — ຄາດຫວັງວ່າຈະຂາດທຶນຫຼາຍກວ່າ predict_pair ຖ້າສູດບໍ່ມີສັນຍານຈິງ.
-- ---------------------------------------------------------------------
...
INSERT INTO puplatao_bet_rates (bet_kind, label_lo, multiplier, fair_prob) VALUES
  ...
  ('avoid_pair',   'ຄູ່ລູກ ຄວນຫຼີກ — ອອກທັງສອງ',    6.00, 0.1389)
